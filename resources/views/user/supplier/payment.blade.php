                ...
                <div class="card">
                    @if(count($payments))
                        ...
                        <div class="card-header no-print">
                            <div class="row">
                                <div class="col-md-1">
                                    <a href="{{ route('pending.supplier.arrears') }}" class="btn btn-link"><span
                                ...
                                <table class="table table-hover biz">
                                    ...
                                    @foreach($payments as $payment)
                                        <tr>
                                            ...
                                            <td>{{ $payment->supplier_arrear->supplier->name }}</td>
                                            <td>{{ $payment->supplier_arrear->stock->price->itemName }}</td>
                                            <td>{{ $payment->supplier_arrear->stock->SKU }}</td>
