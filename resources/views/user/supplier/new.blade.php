                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><span class="fa fa-plus-square"></span> New Supplier</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                <form role="form" action="{{ route('new.supplier') }}" method="post"
                                      id="{{ config('app.env') }}">
                                    @csrf
                                    <div class="card-body">
                                        @include('inc.alert')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-block"><span
                                                        class="fa-plus-square fa"></span> Add New Supplier
                                            </button>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
