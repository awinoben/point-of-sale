                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <hr>
                            <h3 class="profile-username text-center">System User</h3>
                            <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <table class="table table-hover table-responsive">
                                                    ...
                                                    <tr>
                                                        <td><h3><span class="fa fa-lock text-primary"></span></h3>
                                                        </td>
                                                        <td><p>{{ auth()->user()->pin }}</p></td>
                                                    </tr>
                                                    <tr>
                                                        <td><h3><span class="fa fa-bank text-primary"></span></h3>
                                                        </td>
                                                        <td><p>KES {{ number_format(auth()->user()->salary,2) }}</p>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <center>
