...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>{{ $purchase->purchaseNO }} Receipt</h5>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h4>
                                    <a href="{{ url()->current() }}"> <img src="{{ asset('img/logo.png') }}" alt="logo"
                                                                           style="width: 60px;height: 50px;"></a> {{ env('B_NAME') }}
                                </h4>
                            </div>
                            <!-- /.col -->
                        </div>
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                <a href="{{ route('sales') }}" class="btn btn-default"><i
                                        class="fa fa-shopping-basket"></i></a>
                                <a href="{{ route('print.purchase',['NO'=>$purchase->purchaseNO]) }}" target="_blank"
                                   class="btn btn-primary float-right"
                                   style="margin-right: 5px;">
                                    <i class="fa fa-print"></i> Print Receipt
                                </a>
                                <a href="{{ route('print.purchase.with.tax',['NO'=>$purchase->purchaseNO]) }}"
                                   target="_blank"
                                   class="btn btn-success float-right"
                                   style="margin-right: 5px;">
                                    <i class="fa fa-print"></i> Print Receipt (TAX)
                                </a>
                            </div>
                        </div>
                    </div>
