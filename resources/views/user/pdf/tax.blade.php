                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td>{{ number_format($purchase->price -\App\Http\Controllers\SystemController::taxRate($purchase->price)) }}</td>
                                        </tr>
                                        <tr>
                                            <th>Tax ({{ env('NO_TAX_RATE') }}%)</th>
                                            <td>{{ number_format(\App\Http\Controllers\SystemController::taxRate($purchase->price)) }}</td>
                                        </tr>
                                        <tr>
                                            <th>Total:</th>
